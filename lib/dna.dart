        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: const [
              ...
              DNA(index: 10, color: Colors.amber,),
              DNA(index: 8, color: Colors.orange,),
              DNA(index: 6, color: Colors.pink,),
              DNA(index: 4, color: Colors.red,),
              DNA(index: 2, color: Colors.purple,),
              ...
              DNA(index: 12, color: Colors.amber,),
              DNA(index: 14, color: Colors.orange,),
              DNA(index: 16, color: Colors.pink,),
              DNA(index: 18, color: Colors.red,),
              DNA(index: 20, color: Colors.purple,),
            ],
          ),
        ),
      ),
